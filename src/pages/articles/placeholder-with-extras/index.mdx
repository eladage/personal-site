...
import ifIHadOneGIF from './if-i-had-one.gif';

export const meta = {
  author: 'Eric Ladage',
  date: '2022-12-31',
  title: 'Placeholder Article with IMAGES',
  description: 'Lorem ipsum whatever man',
};

export default (props) => <ArticleLayout meta={meta} {...props} />;

This is where some cool article with like images and whatever would be...

<Image src={ifIHadOneGIF} alt="" />
